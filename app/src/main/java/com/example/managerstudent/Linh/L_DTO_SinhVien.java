...
public class L_DTO_SinhVien implements Serializable {
    ...
    public L_DTO_SinhVien(String _MSSV, String _Ten, String _GioiTinh, String _NgaySinh, String _NamHoc, String _Khoa) {
        this._MSSV = _MSSV;
        this._Ten = _Ten;
